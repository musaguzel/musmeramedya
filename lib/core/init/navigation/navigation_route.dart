...
import 'package:musmeramedya/ui/support/view/support_page.dart';
...
class NavigationRoute {
  ...
  Route<dynamic> generateRoute(RouteSettings args) {
    switch (args.name) {
      ...
      case NavigationConstants.SUPPORT:
        return normalNavigate(const SupportPage(), NavigationConstants.SUPPORT ,args.arguments);
